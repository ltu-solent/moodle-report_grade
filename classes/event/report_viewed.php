...
/**
 * The report_grade grade report viewed event.
 *
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventgradereportviewed', 'report_grade');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the grade report for the user with id '$this->relateduserid' " .
