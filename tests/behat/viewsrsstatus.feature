...
Feature: See the status of grades uploaded to Student Records
  ...
  Scenario: SITS Assignments are listed in srs status page, but no grades have been released
  ...
  Scenario: SITS assignment grades are released
    ...
    And I wait until the page is ready
    And I press "Save changes"
    And I set the field "First grade" to "65"
    And I set the field "Marking workflow state" to "In marking"
    And I set the field "Feedback comments" to "Great job no. 2!"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "First grade" to "52"
    And I set the field "Marking workflow state" to "In marking"
    And I set the field "Feedback comments" to "Great job no. 3!"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "First grade" to "48"
    And I set the field "Marking workflow state" to "In marking"
    And I set the field "Feedback comments" to "Great job no. 4!"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "First grade" to "20"
    And I set the field "Marking workflow state" to "In marking"
    And I set the field "Feedback comments" to "Great job no. 5!"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "First grade" to "1"
    And I set the field "Marking workflow state" to "In marking"
    And I set the field "Feedback comments" to "Great job no. 6!"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "First grade" to "0"
    And I set the field "Marking workflow state" to "In marking"
    And I set the field "Feedback comments" to "Great job no. 7!"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "First grade" to "92"
    And I set the field "Marking workflow state" to "In marking"
    And I set the field "Feedback comments" to "Great job no. 8!"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "First grade" to "62"
    And I set the field "Marking workflow state" to "In marking"
    And I set the field "Feedback comments" to "Great job no. 9!"
    And I press "Save changes"
    # Module leader now marks and agrees final grade.
    ...
    And I set the field "Agreed grade" to "65"
    And I set the field "Marking workflow state" to "Marking complete"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "Second grade" to "48"
    And I set the field "Agreed grade" to "48.9"
    And I set the field "Marking workflow state" to "Marking complete"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "Second grade" to "48"
    And I set the field "Agreed grade" to "48.3"
    And I set the field "Marking workflow state" to "Marking complete"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "Second grade" to "48"
    And I set the field "Agreed grade" to "48.5"
    And I set the field "Marking workflow state" to "Marking complete"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "Second grade" to "1"
    And I set the field "Agreed grade" to "1"
    And I set the field "Marking workflow state" to "Marking complete"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "Second grade" to "0"
    And I set the field "Agreed grade" to "0"
    And I set the field "Marking workflow state" to "Marking complete"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "Second grade" to "92"
    And I set the field "Agreed grade" to "92"
    And I set the field "Marking workflow state" to "Marking complete"
    And I wait until the page is ready
    And I press "Save and show next"
    And I set the field "Second grade" to "62"
    And I set the field "Agreed grade" to "62"
    And I set the field "Marking workflow state" to "Marking complete"
    And I press "Save changes"
    # Release the assignments.
    And I am on the "ABC101_A_SEM1_2023/24_ABC10101_002_0" "assign activity" page logged in as moduleleader1
